...
async function fetchBannedUsers() {
  try {
    ...
    if (!users || users.length === 0) {
      list.innerHTML = '<li class="text-white">No currently banned users</li>';
      return;
    }
    ...
    document.getElementById("bannedUsersList").innerHTML = '<li class="text-danger">Error loading banned users</li>';
  }
}
